...
qic(Prov_Code, Att_All_Br, Att_All, data = AE_Data_fun, chart = "pp", show.labels = TRUE)
...
AE_Data_fun_agg %>% ggplot(aes(x = Att_All)) + geom_point(aes(y=comp_p)) + geom_line(aes(y=lcl_inf)) + geom_line(aes(y=ucl_inf)) + geom_line(aes(y=pbar))
...
AE_Data_fun_agg %>% ggplot(aes(x = Att_All, label = prov_label)) +
  geom_point(aes(y=comp_p)) +
  geom_line(aes(y=lcl_inf_win), linetype = "dashed") +
  geom_line(aes(y=ucl_inf_win), linetype = "dashed") +
  geom_line(aes(y=lcl2_inf_win), linetype = "dotted") +
  geom_line(aes(y=ucl2_inf_win), linetype = "dotted") +
  geom_line(aes(y=pbar)) +
  theme_classic() +
  geom_text(aes(y=comp_p, label=prov_label), hjust=-.035, vjust=1.5, size = 3) +
  labs(title = "Funnel plot of 4-hr target performance",
